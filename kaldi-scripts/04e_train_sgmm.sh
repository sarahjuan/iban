...
# SGMM ---> 
#UBM training
steps/train_ubm.sh  600 data/train lang exp/system1/tri3b_ali exp/system1/ubm5b2 || exit 1;

steps/train_sgmm2.sh  11000 25000 data/train lang exp/system1/tri3b_ali exp/system1/ubm5b2/final.ubm exp/system1/sgmm2_5b2 || exit 1;
...
steps/align_sgmm2.sh --nj 4  --transform-dir exp/system1/tri3b_ali  --use-graphs true --use-gselect true data/train lang exp/system1/sgmm2_5b2 exp/system1/sgmm2_5b2_ali  || exit 1; 

steps/make_denlats_sgmm2.sh --nj 4 --sub-split 4  --transform-dir exp/system1/tri3b_ali data/train lang exp/system1/sgmm2_5b2_ali exp/system1/sgmm2_5b2_denlats  || exit 1;
...
steps/train_mmi_sgmm2.sh  --transform-dir exp/system1/tri3b_ali --boost 0.1 --zero-if-disjoint true data/train lang exp/system1/sgmm2_5b2_ali exp/system1/sgmm2_5b2_denlats exp/system1/sgmm2_5b2_mmi_b0.1_z
...
local/score_combine.sh data/test lang exp/system1/tri3b_fmmi_indirect/decode_test_it3  exp/system1/sgmm2_5b2_mmi_b0.1/decode_test_it3 exp/system1/combine_tri3b_fmmi_indirect_sgmm2_5b2_mmi_b0.1/decode_test_it8_3
